...
// イベント中止チェック（旧 api/event-cancel.js を統合）
// ?action=cancel&items=イベント名:月:日,イベント名:月:日,...
...
async function handleCancelCheck(req, res) {
...
export default async function handler(req, res) {
  if (req.query.action === 'cancel') return handleCancelCheck(req, res);
